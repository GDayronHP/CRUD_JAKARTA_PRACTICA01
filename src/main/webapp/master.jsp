    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav mx-auto my-2 my-lg-0 navbar-nav-scroll " style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="IAQuestionMan.jsp">Preguntas</a></li>
            <li><a class="dropdown-item" href="IAAnswersMan.jsp">Alternativas</a></li>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="proveedorMan.jsp">Proveedor</a></li>
            <li><a class="dropdown-item" href="vendedorMan.jsp">Vendedor</a></li>
          </ul>
        </li>
      </ul>
